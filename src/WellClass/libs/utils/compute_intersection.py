...
def compute_intersection(x, y1, y2):
        ...
        x_subset = [x.loc[idx].iloc[0]]
        y1_subset = [y1.loc[idx].iloc[0]]
        y2_subset = [y2.loc[idx].iloc[0]]
        ...
        for offset in offsets:
                y10 = y1.loc[idx].iloc[0]
                y11 = y1.loc[idx+ offset].iloc[0]
                y20 = y2.loc[idx].iloc[0]
                y21 = y2.loc[idx+ offset].iloc[0]

                #check it pressure (y1) at idx is higher than pressure (y2) at idx
                verif_0 = y10>y20
                ...
                if verif_0 and verif_1:
                        x_subset.append(x.loc[idx+offset].iloc[0])
