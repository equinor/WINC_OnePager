...
def plot_sketch(
    ...
    *,
    ...
    casings_plotter(
        ...
        annot_bool=draw_annotation,
        casings_bool=draw_casings,
        c_shoe_bool=draw_casing_shoes,
        c_weld_bool=draw_welded,
    )
    ...
    # draw barriers
    cement_plug_plotter(
        axis=ax, df_barriers=barriers_df, df_barriers_mod=barriers_fmt_df, plug_bool=draw_barriers, annot_bool=draw_annotation, txt_size=TXT_FS_LEFT
    )
    ...
    geology_plotter(
        axis=ax,
        df_geol=geology_df,
        w_header=well_header,
        geol_bool=draw_geology,
        annot_bool=draw_annotation,
        width=AX_WIDTH,
        x_txt_pos=XCOORD_RIGHT,
        txt_size=TXT_FS_RIGHT,
    )
