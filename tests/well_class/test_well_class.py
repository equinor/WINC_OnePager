def test_well_header(well_class_fixture, well_class_dict_fixture) -> None:
    """
    Test well_header
    Args:
...
def test_drilling(well_class_fixture, well_class_dict_fixture) -> None:
    """
    Test drilling
    Args:
        well_class_fixture: fixture for WellClass
...
def test_casings(well_class_fixture, well_class_dict_fixture) -> None:
    """
    Test casings
    Args:
        well_class_fixture: fixture for WellClass
...
def test_barriers(well_class_fixture, well_class_dict_fixture) -> None:
    """
    Test barriers
    Args:
        well_class_fixture: fixture for WellClass
...
def test_well_instantiation_from_dict(well_class_fixture, well_class_dict_fixture):
