...
# plotting libraries
from src.WellClass.libs.plotting import plot_pressure
...
if __name__ == "__main__":
    ...
    parser.add_argument("-mi", "--mixture-index", type=int, default=0, help="option of pre-defined chemical mixtures")

    # evaluation of depth values at which max P is computed.
    parser.add_argument(
        "-maxP", "--max-pressure-depths", nargs="+", type=float, help="option for depths to eavluate at which CO2 gradient reaches Shmin"
    )
    ...
    # display the figure
    parser.add_argument("--display", action="store_true", help="display of the well sketch")
